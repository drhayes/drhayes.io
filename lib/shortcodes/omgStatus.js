function omgStatus(status) {
  return `<article class="stack box omg-status" style="--space: 1em;">
  <div class="stack">
    <div class="with-sidebar" style="--space: var(--s2);">
      <p class="align-self:center font-size:s5">${status.emoji}</p>
