...
describe('Links', () => {
  ...
  describe('getLastSevenDays', () => {
    ...
    it('calls all with the correct arguments', async () => {
      ...
      assert.equal(
        lastPosts.find((post) => post.shared === 'no'),
        undefined
      );
    });
  ...
  describe('processPinboardLink', () => {
    ...
    it('generates a slug', () => {
      ...
      assert.equal(
        result.slug,
        'it-feels-like-react-is-getting-a-bit-of-a-kicking-recently-piccalilli.md'
      );
    });
  });
  ...
  describe('maybeWriteLinkFile', () => {
    ...
    it('creates the directory if it does not exist', async () => {
      ...
      sinon.assert.calledWith(mockFsPromises.mkdir, '/linksdir/2024/02', {
        recursive: true,
      });
    });
    ...
    it('writes a file with the slug as the name', async () => {
      ...
      sinon.assert.calledWith(
        ...
        '/linksdir/2024/02/some-title.md',
        sinon.match.string
      );
    });
