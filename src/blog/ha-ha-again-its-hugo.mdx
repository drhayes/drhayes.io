...
There has to be some trick to get Next to watch the `content` directory. I couldn't find it, though. And I was _basically_ re-writing a system similar to Hugo's, with a `content` directory and automatically generating tag pages. Once that realization struck me I knew I was doomed -- I was gonna convert the site back to Hugo. Ugh.
